...
public class MostrarPedidosUsuarios extends AppCompatActivity {

    RecyclerView vistaPedidos;
    ArrayList<Pedidos> predidosArrayList;
    PedidosUAdapter pedidosAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mostrar_pedidos_usuarios);
        Toolbar bar=findViewById(R.id.toolbar10);
        ...
        processDialog.show();
        vistaPedidos=findViewById(R.id.rvPedidosU);
        ...
        pedidosAdapter=new PedidosUAdapter(MostrarPedidosUsuarios.this,predidosArrayList);
